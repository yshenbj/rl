...
policy_net = DeepQFunction(n_observations, n_actions).to(device)
target_net = DeepQFunction(n_observations, n_actions).to(device)
...
def execute(num_episodes=50):
    ...
    for i_episode in range(num_episodes):
        ...
        print("{:d}({:.2f}) ".format(i_episode, episode_reward), end="", flush=True)    
